    ...
    <main className="min-h-screen bg-[#fef7f0]">
      ...
      <section className="relative min-h-screen flex items-end">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pb-24 pt-32">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-[#6b6560] leading-relaxed max-w-lg mb-10">
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-[#a8a29e] text-sm tracking-widest uppercase">
          Scroll
          <svg className="w-5 h-5 mx-auto mt-2 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-24 bg-[#2d2a26] text-[#fef7f0]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <svg className="w-12 h-12 mx-auto mb-8 text-[#ff6b9d] opacity-60" fill="currentColor" viewBox="0 0 24 24">
            <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
          </svg>
          <blockquote className="font-serif text-3xl md:text-4xl font-medium italic leading-relaxed mb-8">
            &ldquo;I&apos;m known for helping executive teams and boards translate complex technology into clear strategic choices, particularly during periods of disruption, reinvention, and market transition.&rdquo;
          </blockquote>
          <cite className="text-[#a8a29e] not-italic text-sm tracking-widest uppercase">
            — On her approach to advisory work
          </cite>
        </div>
      </section>
      ...
      <footer className="py-12 px-6 lg:px-8 border-t border-[#e5ddd4]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[#a8a29e] text-sm">
            &copy; 2024 Lakecia Gunter. All rights reserved.
          </p>
